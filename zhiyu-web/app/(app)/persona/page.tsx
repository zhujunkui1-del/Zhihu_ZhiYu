...
export default function PersonaPage() {
  ...
  /* Agent 状态图：旧版用的是三个 Agent 动画 GIF，新设计改为刘看山角色插画，
     按状态在两张角色图之间切换（资源在 public/assets/characters/）。 */
  const agentFig = busy || sbtiDone ? "/assets/characters/newfriend.webp" : "/assets/characters/self.webp";
          ...
          {tab === "card" ? (
            <div className="dash-grid">
              ...
              <section className="card" style={{ textAlign: "center" }}>
                ...
                <img className="agent-fig" src={agentFig} alt="Agent 状态" style={{ margin: "10px auto" }} />
                <p className="meta">
